...
const CardPersonalComponent = () => {
  return (
    <div className="row justify-content-center margin-bottom">
      ...
      <div className="col-lg-2 col-xs-4 col-medidas mb-5">
        <div className="card mx-auto my-5 bg-card border-color">
          <div className="row">
            <div className="col-8">
              <img
                src={beli}
                alt="Foto del rostro de la persona 1"
                className="mx-auto d-block pb-5 pt-2 bg-image"
              />
            </div>
            <div className="col-4 mt-4">
              ...
              >
                <img
                  ...
                  className="small rounded-circle mx-auto d-block bg-linkedin"
                />
              </Link>
            </div>
          </div>
          <h3 className="card-title text-center mt-2 titulo-color">
            Belén Oyarce
          </h3>
          <h3 className="card-title text-center mt-2 mb-5 titulo-color2">
            Scrum Master Developer
          </h3>
        </div>
      </div>
      <div className="col-lg-2 col-xs-4 col-medidas mb-5">
        <div className="card mx-auto my-5 bg-card ">
          <div className="row">
            <div className="col-8">
              <img
                src={alfo}
