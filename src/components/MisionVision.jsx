...
const MisionVisionComponent = () => {
  return (
    <div className="container-fluid py-4 mb-5">
      <h1 className="text-center mb-3 py-5">
        <span className="text-color1 text-tipo">Nuestra </span>
        <span className="text-color2 text-tipo">misión </span>
        <span className="text-color1 text-tipo">y</span>
        <span className="text-color3 text-tipo"> visión</span>
      </h1>
      <div className="container">
        <div className="row">
          <h1 className="py-5 text-color2 text-nuestra ">Nuestra Misión</h1>
        ...
        <div className="row">
          <h1 className="py-5 text-color2 text-nuestra text-color3">
            Nuestra Visión
          </h1>
          <div className="col-lg-8 col-12">
            <p className="parrafo text-justify">
